...
_purchase_info_asset ctrlSetStructuredText parseText format ["<t align = 'center' size = '%2'>%1</t>", ((BIS_WL_purchasable # _id) # (lbCurSel _purchase_items)) # 5, (0.85 call BIS_fnc_WLSubroutine_purchaseMenuGetUIScale)];
_cost = _purchase_items lbValue lbCurSel _purchase_items;
_requirements = ((BIS_WL_purchasable # _id) # (lbCurSel _purchase_items)) # 2;
