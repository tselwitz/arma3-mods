...
if (_isMan) then {BIS_WL_matesInBasket = BIS_WL_matesInBasket + 1} else {BIS_WL_vehsInBasket = BIS_WL_vehsInBasket + 1};

if (_isStatic) exitWith {"close" call BIS_fnc_WLPurchaseMenu; [_class, _cost] spawn BIS_fnc_WLDefenceSetup};
